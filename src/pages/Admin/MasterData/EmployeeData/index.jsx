            ...
            <div className='rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1 mt-6'>
                ...
                <div className='max-w-full overflow-x-auto py-4'>
                    <table className='w-full table-auto'>
                        ...
                        <tbody>
                            {dataPegawai.map((employee) => {
                                return (
                                    <tr key={employee.id}>
                                        <td className='border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark'>
                                            <div className="h-12.5 w-15">
                                                <div className='rounded-full overflow-hidden'>{employee.photo}</div>
                                            </div>
                                        </td>
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{employee.namaPegawai}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{employee.jenisKelamin}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{employee.tanggalMasuk}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{employee.status}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{employee.hakAkses}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
